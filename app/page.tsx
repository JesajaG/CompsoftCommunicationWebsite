...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3">
            <img
              src="https://ik.imagekit.io/1ejspnv0y/Compsoft%20Communications/photo_2025-10-01_18-55-27.jpg?updatedAt=1759391243314"
          ...
          <div className="hidden md:flex space-x-8">
            {["Home", "About", "Services", "Solutions", "Cyber Security", "Clients & Partners", "Contact"].map(
              (item, index) => (
                <motion.button
                  key={item}
      ...
      {activeSection === "home" && (
        <>
          <div className="h-8 sm:h-10 bg-white mt-16 sm:mt-20"></div>
          ...
          >
            ...
            >
              <motion.h1
                ...
                className="text-3xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter mb-4 sm:mb-6 leading-tight drop-shadow-lg"
              >
              ...
              <motion.h2
                ...
                className="text-xl sm:text-3xl md:text-5xl font-semibold tracking-tight mb-6 sm:mb-8 leading-tight drop-shadow-lg"
              ></motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.6, duration: 0.8 }}
                className="mt-6 sm:mt-8 max-w-3xl mx-auto text-base sm:text-xl leading-relaxed text-white px-4 drop-shadow-lg"
              ></motion.p>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white animate-bounce z-10">
              <span className="text-xs sm:text-sm font-medium drop-shadow-lg">Scroll Down</span>
              <svg
              ...
              <div className="relative">
                <div className="flex animate-scroll space-x-12">
                  ...
                  <div className="flex space-x-12 min-w-max">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/first-national-bank-logo-png_seeklogo-464484-pJ7Vv54n9Ner3WiVR8mxMdWiPFS8fD.png"
                      alt="First National Bank"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/pngegg-c2PBz96W59iJkOfg5KLF9lvoNCcqyB.png"
                      alt="Standard Bank"
                      className="h-12 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/images-sxALGyLUAQ5PiN3X4wND3MFk2ZhdVW.png"
                      alt="EOS Capital"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Unknown..-nRz2jkW26UvxNbGYYxA7YDJBRAZUKz.png"
                      alt="Namcor"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Screenshot%202019-03-08%20at%2011.52.21-buSdSs6r6kWQsjtPQyTeaQGaFbKFHn.png"
                      alt="Effort Investment Holdings"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Unknown.-oCjlTji0YBgDODQzVAxo7LmLjIBRQr.png"
                      alt="Konrad"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Unknown-fEV9qtchJEoyEEs3GarKMFuKuUfAkK.png"
                      alt="Transnamib"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Unknown3-H87FOvLySDc2onLwhbo5RmNnrypxDJ.png"
                      alt="MVA"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Unknown-IQcXXmxu3IJOHjQbi91UVwwxFVgtLW.jpeg"
                      alt="Namib Nuclear"
                      className="h-16 w-auto object-contain transition-all duration-300 hover:scale-110"
                    />
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/rfsol_logo-kwTfCOexkZtMDqa7In0AeaGSgAlw0D.jpeg"
          ...
          {/* Compsoft Image Section */}
          <section className="py-16 bg-background">
            <div className="max-w-5xl mx-auto px-6 text-center">
              <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-8 md:gap-12">
                {/* Left Image */}
                <motion.div
                ...
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-4 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/aezIwRgtJ2YaLWoDzvhh4-Wpp16D4scg8wnz1HkEti6PN2y1722s.png"
                      alt="Left Partner Logo"
                      className="h-24 w-auto object-contain hover:scale-110 transition-all duration-500 hover:rotate-1"
                    />
                  </div>
                </motion.div>

                {/* Center Image - Compsoft Communications */}
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  ...
                  className="flex justify-center"
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-8 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Compsoft-Jb50ozdbw7PC6992YqcRmLu5tocwDf.png"
                      alt="Compsoft Communications"
                      className="h-48 w-auto object-contain hover:scale-110 transition-all duration-500 hover:rotate-1"
                    />
                  </div>
                </motion.div>
                ...
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-4 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/DYQdgIg418fa0wxdz9wCP-d73NSt5NYplA6G2k5D6VDdcDl4i9l3.png"
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              >
                ...
                <p className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-700">
                  Compsoft Communications is a leading ICT solutions and service provider in Namibia. We are dedicated
                  to delivering innovative and reliable technology solutions that empower businesses to thrive in the
                  digital age.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 gap-8 mt-16 max-w-4xl mx-auto mb-16">
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-6 md:p-8 border border-red-100 hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 flex flex-col"
                >
                  <div className="mb-6 rounded-2xl overflow-hidden">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/photo_2025-09-11_10-42-58-Di4cNHzGOZUSDFMjhFTXeCkmhu6KiU.jpg"
              ...
              >
                <div className="max-w-4xl mx-auto">
                  <img
                    src="https://ik.imagekit.io/1ejspnv0y/structuredcabling-1M6P281IJr4f0weYEP-AwQ.gif?updatedAt=1759065034384"
                    alt="Structured Cabling Solutions"
                    className="w-full h-auto rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-2"
                  />
                </div>
              </motion.div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-8 items-center justify-center">
                  {[
                    ...
                    {
                      name: "Cisco",
                      logo: "https://ik.imagekit.io/1ejspnv0y/images/cisco.png?updatedAt=1757199190087",
                    },
                    { name: "Dell", logo: "https://ik.imagekit.io/1ejspnv0y/images/dell.png?updatedAt=1757199190067" },
                    {
                      name: "Jabra",
                      logo: "https://ik.imagekit.io/1ejspnv0y/images/jabra.png?updatedAt=1757199189553",
                    },
                    {
                      name: "Polycom",
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  <img
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/istockphoto-1094914628-612x612-ET5SP0cYFjyiV2LBKrEW7pcJynGBsk.jpg"
                ...
                >
                  <img
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/istockphoto-504480697-612x612-WdPDWZPPHsWvc7RAeTSy0DzHuULXtm.jpg"
                    alt="Business Communications"
                    className="w-full h-64 object-cover rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
                  />
                </motion.div>
                <motion.div
                ...
                >
                  <img
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/istockphoto-1337471411-612x612-QiC5tSKp6iuRB6KuDtUgzYhKJD8HDx.jpg"
          ...
          {activeSection === "clients-and-partners" && (
            <section id="clients-and-partners" className="py-24 border-t relative overflow-hidden bg-gray-50">
              <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-8 items-center justify-center">
                    {[
                      ...
                      {
                        name: "Dell",
                        logo: "https://ik.imagekit.io/1ejspnv0y/images/dell.png?updatedAt=1757199190067",
                      },
                      {
                        name: "Jabra",
                        logo: "https://ik.imagekit.io/1ejspnv0y/images/jabra.png?updatedAt=1757199189553",
                ...
                >
                  <p className="mx-auto max-w-2xl text-2xl font-semibold leading-relaxed text-gray-800">
                    Join these industry leaders who trust Compsoft Communications to deliver innovative ICT solutions
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  >
                    ...
                    <p className="text-gray-600 leading-relaxed">NO. 4 Adler Street, Windhoek West, Namibia</p>
                    <p className="text-gray-600 leading-relaxed">PO Box 6759</p>
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Phone:{" "}
                      <a href="tel:+264851478637" className="text-blue-600 hover:text-blue-800 transition-colors">
                        +264851478637
                      </a>
                    </p>
                  </motion.div>
        ...
        <section id="solutions" className="py-24 border-t relative overflow-hidden bg-white">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="space-y-16">
              ...
              <div>
                <h3 className="relative mb-8 text-3xl font-bold tracking-tight after:absolute after:bottom-[-8px] after:left-0 after:h-1 after:bg-gradient-to-br after:from-blue-500 after:to-red-500 after:rounded-full">
      ...
      {activeSection === "cyber-security" && (
        <section id="cyber-security" className="py-24 border-t relative overflow-hidden bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            {/* Video Section */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              <video autoPlay muted loop playsInline className="w-full h-auto">
                <source
                  src="https://ik.imagekit.io/1ejspnv0y/Compsoft/Cyber%20Security.mp4?updatedAt=1759390036133"
                  type="video/mp4"
                />
              </video>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-blue-900">WE KEEP YOU SECURED AT ALL TIMES</h1>
              <p className="text-lg md:text-xl text-gray-900 max-w-3xl mx-auto mb-8">
                Our services give you an innovative set of tools, exclusive resources, and easy-to-manage cybersecurity
                solutions to effectively grow your business
              </p>
              <p className="text-xl md:text-2xl font-semibold text-blue-600">
                We offer clients smart cybersecurity with
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  features: ["Real-time scanning", "Automated responses", "Threat intelligence"],
                },
                {
                  title: "Smart Management",
                  description: "Centralized security management platform",
                  features: ["Dashboard monitoring", "Policy management", "Automated updates"],
                },
                {
                  title: "Collective Protection",
                  description: "Comprehensive security across all endpoints",
                  features: ["Multi-layer defense", "Network security", "Data encryption"],
                },
                {
                  title: "Smarter Future",
                  description: "AI-powered security solutions",
                  features: ["Machine learning", "Predictive analytics", "Adaptive security"],
                },
                {
                  title: "Smart Support",
                  description: "24/7 expert security support",
                  features: ["Dedicated team", "Quick response", "Expert guidance"],
                },
                {
                  title: "Fast Incident Response",
                  description: "Rapid threat mitigation and recovery",
                  features: ["Immediate action", "Forensic analysis", "Recovery planning"],
                },
                {
                  title: "Threat Intelligence",
                  description: "Stay ahead of emerging threats",
                  features: ["Global threat data", "Risk assessment", "Proactive defense"],
                },
              ].map((service, index) => (
                <motion.div
                  key={service.title}
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.7, delay: index * 0.1 }}
                  className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-blue-100 hover:shadow-3xl transition-all duration-300 hover:-translate-y-2"
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mb-6 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-12 border border-red-100 text-center"
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">Ready to Secure Your Business?</h2>
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Contact us today to learn more about our comprehensive cybersecurity solutions and how we can protect
                your business from evolving threats.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="tel:+264851478637"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                ...
                <a
                  href="mailto:info@compsoft.com.na"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
